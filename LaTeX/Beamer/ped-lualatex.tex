...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\documentclass[tiksz]{beamer}
\documentclass{beamer}
\usetheme[faculty=ped]{fibeamer}
\usepackage{polyglossia}  %% By using `czech` or `slovak` as the
\setmainlanguage{greek} %% main locale instead of `english`, you
...
\title{Εκτίμηση της Σεισμικής Τρωτότητας και Διακινδύνεσυης στην Πρώτη Γραμμή του Μετρό Θεσσαλονίκης} %% that will be typeset on the
\subtitle{Διπλωματική Εργασία} %% title page.
...
\begin{document}
  ...
  \AtBeginSection[]{% Print an outline at the beginning of sections
    \begin{frame}<beamer>
      \frametitle{Περιεχόμενα Ενότητας}
	...
	\begin{darkframes}
		...
		\section{Εισαγωγή}
		\subsection{Σκοπός}
		\subsection{Χαρακτηριστικές Περιπτώσεις}
		...
		\section{Επικινδυνότητα}
		\subsection{Σεισμικότητα}
		\subsection{Αιτιοκρατική Μέθοδος}
		\subsection{Πιθανοτική Μέθοδος}
		...
		\section{Τρωτότητα}
		\subsection{Αριθμητικές Αναλύσεις}
		\subsection{title}
		
		
		
		\section{Διακινδύνευση}
		\subsection{Έκθεση}
		\subsection{Εκτίμηση Διακινδύνευσης}
		...
		\subsection{Συμπεράσματα}
			\begin{frame}{\insertsection}
				...
				\framesubtitle{\insertsubsection}
				\begin{enumerate}
					\item <1->  \only<2>{Δεν γίνεται ένας προπτυχιακός φοιτητής να εκτιμήσει την σεισμική τρωτότητα} \only<3->{Δεν γίνεται \sout{ένας προπτυχιακός φοιτητής} να εκτιμήσω την σεισμική τρωτότητα}
					\item <3->
				\end{enumerate}
		
			\end{frame}

		\subsection{Επέκταση Έρευνας}
   ...
   %     \node[anchor=south east,xshift=-30pt,yshift=35pt]
    ...
    \begin{columns}
    	...
    	\begin{column}{0.4\textwidth}
    		\begin{figure}
    			\centering
    			\includegraphics[width=0.95\textwidth]{resources/jabberwocky-dark}
    			\caption{Jabberwocky}
    		\end{figure}
   		\end{column}
...
%    	\animategraphics[label=parallelogramme, autoplay]{30}{parallelogramme}{}{}
%    \end{frame}
